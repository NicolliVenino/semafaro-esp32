...
|Ir além: Implementou um componente de extra, fez com millis() ao invés do delay() e/ou usou ponteiros no código |	Até 1 |	Até 0,5 |	0.5 | Utiliza millis(), porém não faz uso de nenhum outro componente. |	
| | | | |Pontuação Total: 9.5 |
...
|Critério|	Contempla (Pontos)|	Contempla Parcialmente (Pontos)	|Não Contempla (Pontos)	|Observações do Avaliador|
|-|-|-|-|-|
|Montagem física com cores corretas, boa disposição dos fios e uso adequado de resistores	|Até 3	|Até 1,5	| 3 | Uso adequado de resistores e bom uso do espaço. |	
...
|Ir além: Implementou um componente de extra, fez com millis() ao invés do delay() e/ou usou ponteiros no código |	Até 1 |	Até 0,5 |	0.5 | Embora utilize millis() ao invés de delay(), não vai além. |	
| | | | |Pontuação Total: 9.5 |
